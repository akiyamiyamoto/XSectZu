...
set label 71 at 230,280 font ",14" "$Zh$" textcolor rgb chiggs
set label 72 at 300,25 font ",14" '$\nu_e\overline{\nu}_eh$' textcolor rgb chiggs
set label 73 at 235,11 font ",14" '$e^{+}e^{-}h$' textcolor rgb chiggs
set label 74 at 700,0.2 font ",14" '$zhh$' textcolor rgb chiggs
set label 75 at 700,0.025 font ",14" '$\nu\bar{\nu}hh$' textcolor rgb chiggs
set label 76 at 900,0.015 font ",14" '$e^{+}e^{-}hh$' textcolor rgb chiggs
...
#
#
set label 51 at 800,1.5 font ",14" '$e^{+}e^{-}ZZ$' textcolor rgb c2fvtwo
set label 52 at 330,1.5 font ",14" '$e^{\pm}{\stackrel{(-)}{\nu}} W^{\mp}Z$' textcolor rgb c2fvtwo rotate by 45
...
#
#
set arrow from 500,0.01 to 500,1E8 nohead lw 1 dt (5,8) 
set arrow from 250,0.01 to 250,1E8 nohead lw 1 dt (5,8) lc rgb smcolor
...
plot sprintf("../%s/zh.dat", datadir) with lines lc rgb chiggs, \
     ...
     sprintf("../%s/zhh.dat", datadir) with lines lc rgb chiggs, \
     sprintf("../%s/nnhh.dat", datadir) with lines lc rgb chiggs, \
     sprintf("../%s/eehh.dat", datadir) with lines lc rgb chiggs, \
...
! mv graph2.pdf smcros-hh.pdf 
! convert smcros-hh.pdf smcros-hh.png

print "### ",outdir,"/smcros-hh.png was created."
